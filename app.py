...
from langchain.chat_models import AzureChatOpenAI  # Corrected import for AzureChatOpenAI
from langchain.embeddings import OpenAIEmbeddings  # Corrected import for embeddings
    ...
    if uploaded_file:
        with st.spinner('Processing PDF...'):
            ...
            embeddings = OpenAIEmbeddings(
                ...
                azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),
                model="text-embedding-ada-002"  # Replace with your specific deployment model
            )
